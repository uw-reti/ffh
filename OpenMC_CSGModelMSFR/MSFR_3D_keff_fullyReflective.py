...
# Heat Exchanger
HX_top=openmc.ZPlane(z0=0.85*100, boundary_type='reflective')
HX_bottom=openmc.ZPlane(z0=-0.85*100, boundary_type='reflective')
HX_outside=openmc.ZCylinder(r=2.27*100, boundary_type='reflective')
HX_inside=openmc.ZCylinder(r=1.835*100, boundary_type='reflective')

# Box above and below HX
box_top=openmc.ZPlane(z0=0.95*100, boundary_type='reflective')
box_bottom=openmc.ZPlane(z0=-0.95*100, boundary_type='reflective')
box_outside=openmc.ZCylinder(r=2.17*100, boundary_type='reflective')
box_inside=openmc.ZCylinder(r=1.935*100, boundary_type='reflective')

# Curve above the HX
inner_curve_top=openmc.ZTorus(a=1.785*100,x0=0,y0=0,z0=0.95*100,b=0.15*100,c=0.15*100, boundary_type='reflective')
outer_curve_top=openmc.ZTorus(a=1.785*100,x0=0,y0=0,z0=0.95*100,b=0.385*100,c=0.385*100, boundary_type='reflective')
# use box_top as bottom of curve
curve_to_slant_bound=openmc.ZCylinder(r=1.785*100)

# Curve below the HX
inner_curve_bottom=openmc.ZTorus(a=1.785*100,x0=0,y0=0,z0=-0.95*100,b=0.15*100,c=0.15*100, boundary_type='reflective')
outer_curve_bottom=openmc.ZTorus(a=1.785*100,x0=0,y0=0,z0=-0.95*100,b=0.385*100,c=0.385*100, boundary_type='reflective')

# Core planes
# top_wall=openmc.Cone(x0=0,y0=0,z0=0.8,dx=0,dy=1.785,dz=1.325, boundary_type='reflective')
# bottom_wall=openmc.Cone(x0=0,y0=0,z0=-0.8,dx=0,dy=1.785,dz=-1.325, boundary_type='reflective')
top_wall=openmc.ZCone(x0=0,y0=0,z0=0.8*100,r2=11.56, boundary_type='reflective')
top_cone_midplane=openmc.ZPlane(z0=0.8*100)
bottom_wall=openmc.ZCone(x0=0,y0=0,z0=-0.8*100,r2=11.56, boundary_type='reflective')
bottom_cone_midplane=openmc.ZPlane(z0=-0.8*100)
core_outerCyl=openmc.ZTorus(a=2.32*100,x0=0,y0=0,z0=0,b=1.265*100,c=1.265*100, boundary_type='reflective')
# Small planes parallel to walls
# top_small=openmc.Cone(x0=0,y0=0,z0=0.575,dx=0,dy=1.785,dz=1.325, boundary_type='reflective')
# bottom_small=openmc.Cone(x0=0,y0=0,z0=-0.575,dx=0,dy=1.785,dz=-1.325, boundary_type='reflective')
top_small=openmc.ZCone(x0=0,y0=0,z0=0.575*100,r2=11.56, boundary_type='reflective')
top_small_cone_midplane=openmc.ZPlane(z0=0.575*100)
bottom_small=openmc.ZCone(x0=0,y0=0,z0=-0.575*100,r2=11.56, boundary_type='reflective')
