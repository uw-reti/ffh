...
# Very accurate parameters - trying to get around 1 pcm uncertainty 
#batches = 1000
#inactive = 50
#particles = 1500000
...
os.rename('statepoint.550.h5', 'MOSARTstatepoint.550.h5')

# Load the last statepoint file
sp = openmc.StatePoint('MOSARTstatepoint.550.h5') #change this with the simulation parameters 'statepoint.n.h5' n=number of batches
