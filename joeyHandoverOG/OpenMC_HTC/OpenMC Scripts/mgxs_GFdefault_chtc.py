...
# Density Calculation - source in salt properties document
#rho_salt = 4.787 - (8.44*10**-4)*FStemp
#print(rho_salt)
...
sp = openmc.StatePoint('GFDstatepoint.550.h5') #change this with the simulation parameters 'statepoint.n.h5' n=number of batches
